...
export default function login() {
  ...
  return (
    <div className="w-full h-[625px] bg-slate-800 flex  ">
      ...
      <div className="w-[60%] flex items-center gap-4 flex-col justify-center">
        ...
        >
          <SportsEsportsIcon className="w-5 h-5" />
          Login with Discord
        </Button>
        <Button
        ...
        {/* <Button className="flex items-center justify-center gap-3 w-[20rem] h-10 rounded-sm bg-cyan-500">
          <ArrowPathIcon strokeWidth={2} className="h-5 w-5" />Login with Google
        </Button> */}
      </div>
    </div>
  );
